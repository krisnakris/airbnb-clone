    ...
    <>
      <header
        className={`sticky top-0 z-50 grid grid-cols-3 ${
          show ? 'bg-white' : searchInput ? 'bg-white' : 'bg-transparent'
        } px-5 py-2 shadow-md md:px-10 transition duration-600 ease-out`}
      >
        {/* Left section */}
        <div
          onClick={() => router.push('/')}
        ...
        <div className="flex items-center md:border-2 rounded-full py-2 md:shadow-sm">
          <input
            ...
            className={`pl-5 flex-grow bg-transparent outline-none text-sm text-gray-600 ${
              show ? 'placeholder-gray-400' : 'placeholder-white'
            }`}
          />
